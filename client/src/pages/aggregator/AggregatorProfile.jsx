            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div className="flex items-center gap-5">
                    ...
                    <div className="space-y-1">
                        <h1 className="text-2xl text-slate-900 tracking-tight font-bold">Business Profile</h1>
                        <p className="text-sm text-slate-500">Manage your business details and view performance records.</p>
                    </div>
                </div>
                <button
                            ...
                            <div className="flex-1 space-y-6 text-center md:text-left">
                                <div className="space-y-2">
                                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
                                        <h2 className="text-3xl font-bold text-slate-900 tracking-tighter">{user?.aggregator_details?.enterpriseName || user?.name || "Business"}</h2>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 border-t border-slate-50">
                                    {[
                                        { icon: QrCode, label: "Business License", value: user?.aggregator_details?.license || "PENDING" },
                                        { icon: MapPin, label: "Business Location", value: formatLocation(user?.address) || "Not Set" },
                                        { icon: Phone, label: "Phone Number", value: user?.phone || "+91 (555) 001-9872" },

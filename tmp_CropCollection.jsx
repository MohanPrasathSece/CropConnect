...
const CropCollection = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    purchasePrice: '',
    collectionLocation: {
      farmAddress: formatLocation(cropData?.farmer?.address) || '',
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!aiAnalysis) {
      setError("Quality assessment is required before collection.");
      return;
    }
    ...
    <div className="max-w-6xl mx-auto space-y-12 pb-20 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
        <div className="flex items-center gap-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Collect Crop</h1>
            <p className="text-sm text-slate-500 font-medium flex items-center gap-2 mt-1">
              <Shield className="w-4 h-4 text-emerald-500" />
              Verify Quality and Update Inventory
            </p>
          </div>
        </div>
        <div className="hidden lg:flex items-center gap-4 bg-white p-3 rounded-2xl border border-slate-100 shadow-sm">
          ...
          <div className="pr-4">
            ...
            <p className="text-sm font-bold text-slate-900 mt-1">Ready</p>
          </div>
        </div>
      </div>
        ...
        <div className="lg:col-span-8 space-y-12">
          ...
          <div className="bg-white rounded-[56px] p-12 border border-slate-100 shadow-sm relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 relative z-10">
              ...
              <div className="space-y-2">
                <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Available Quantity</p>
              ...
              <div className="space-y-2">
                <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Farmer ID</p>
          ...
          <div className="bg-slate-900 rounded-[56px] p-12 text-white relative overflow-hidden shadow-2xl shadow-slate-900/30 group">
            ...
            <div className="relative z-10 space-y-10">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 border-b border-white/10 pb-10">
                <div>
                  <h2 className="text-[10px] font-bold text-emerald-400 uppercase tracking-[0.3em] mb-3">Quality Check</h2>
                  <h3 className="text-4xl font-bold tracking-tighter">Assessment Method</h3>
                </div>
              ...
              {!aiAnalysis ? (
                <div className="space-y-8">
                    ...
                    <div className="space-y-8">
                      <div className="border-2 border-dashed border-white/10 rounded-[40px] p-16 text-center group/capture hover:border-emerald-500/50 hover:bg-white/5 transition-all cursor-pointer relative">
                        ...
                        <div className="flex flex-col items-center gap-6 relative z-10">
                          ...
                          <div className="space-y-2">
                            <p className="text-base font-bold text-white/80 uppercase tracking-widest">Take Crop Photo</p>
                            <p className="text-[10px] text-white/40 font-bold uppercase tracking-[0.2em]">For AI Quality Analysis</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="pt-4">
                          <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-2xl p-4 flex items-center gap-4">
                            ...
                            <p className="text-[10px] text-emerald-400 font-bold uppercase tracking-tight italic">Enter physical metrics manually to verify quality.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <span className="text-[12px] font-bold uppercase tracking-[0.2em]">{verificationMode === 'ai' ? 'Analyze Photo' : 'Analyze Data'}</span>
                  </button>
                </div>
              ) : (
                <div className="bg-white/5 border border-white/10 rounded-[40px] p-10 space-y-12 animate-in zoom-in duration-700">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 border-b border-white/10 pb-10">
                    <div className="flex items-center gap-8">
                      ...
                      <div className="space-y-1">
                        <p className="text-[10px] font-bold text-emerald-400 uppercase tracking-[0.3em]">Quality Grade</p>
                        <h4 className="text-3xl font-bold text-white tracking-tighter capitalize">
                          {aiAnalysis.overallGrade === 'Premium' ? 'Premium Quality' : `Grade ${aiAnalysis.overallGrade}`}
                        </h4>
                      </div>
                    </div>
                  ...
                  <div className="pt-6 flex flex-col sm:flex-row gap-4">
                    ...
                    <div className="flex-1 px-8 py-5 bg-emerald-500/10 border border-emerald-500/20 rounded-[24px] flex items-center gap-4">
                      ...
                      <span className="text-[11px] font-bold text-emerald-400 uppercase tracking-widest">Quality Assessment Complete</span>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-8">
                <label className="block space-y-3">
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] ml-1">Collected Quantity</span>
                ...
                <label className="block space-y-3">
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] ml-1">Purchase Price (Total)</span>
                  <div className="relative group/input">
              ...
              <div className="space-y-8">
                <label className="block space-y-3">
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] ml-1">Storage Facility</span>
                  <div className="relative group/input">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <label className="block space-y-3">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] ml-1">Temperature (°C)</span>
                    <div className="relative group/input">
                  ...
                  <label className="block space-y-3">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] ml-1">Humidity (%)</span>
                    <div className="relative group/input">
          ...
          <div className="bg-white rounded-[56px] border border-slate-100 shadow-xl shadow-slate-200/50 p-12 space-y-10 sticky top-12">
            ...
            <div className="space-y-8 relative before:absolute before:left-[15px] before:top-4 before:bottom-4 before:w-[2px] before:bg-slate-50">
              <div className="flex gap-8 group/step relative z-10">
                ...
                <div className="space-y-1">
                  <p className="text-[11px] font-bold text-slate-900 uppercase tracking-widest">Crop Selected</p>
                  <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tight">Farmer's QR scanned successfully</p>
                </div>
              </div>
              <div className="flex gap-8 group/step relative z-10">
                ...
                <div className="space-y-1">
                  <p className={`text-[11px] font-bold uppercase tracking-widest transition-colors ${aiAnalysis ? 'text-slate-900' : 'text-slate-300'}`}>Quality assessment</p>
                  <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tight">Analyzing crop quality data</p>
                </div>
              </div>
              <div className="flex gap-8 group/step relative z-10">
                ...
                <div className="space-y-1">
                  <p className="text-[11px] font-bold text-slate-300 uppercase tracking-widest">Final Step</p>
                  <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tight">Save to complete collection</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-10 border-t border-slate-50 space-y-8">
              <div className="space-y-2">
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] text-center">Total Purchase Amount</p>
              ...
              >
                {loading ? (
                  ...
                  <>
                    Finalize Collection <ChevronRight className="w-4 h-4 text-emerald-500 group-submit:translate-x-1 transition-transform" />
                  </>
                )}
              </button>
            </div>
